...
export default function BlackburnPage() {
  return (
    <SuburbLanding
      ...
      slug="blackburn"
      postcode="3130"
      introEn="Trusted, eco-friendly cleaning visits for cat owners across Blackburn. We scoop, remove, sanitize and vacuum – from just $28 per visit."
      introCn="为 Blackburn 各地养猫家庭提供值得信赖的环保上门清洁服务。我们清理、带走粪便、消毒并吸尘 —— 每次仅需 $28 起。"
      nearby={[
