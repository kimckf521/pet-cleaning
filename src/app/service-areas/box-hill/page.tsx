...
export default function BoxHillPage() {
  return (
    <SuburbLanding
      ...
      slug="box-hill"
      postcode="3128"
      introEn="Reliable, eco-friendly cleaning visits for cat owners across Box Hill. We scoop, remove, sanitize and vacuum – from just $28 per visit."
      introCn="为 Box Hill 各地养猫家庭提供可靠、环保的上门清洁服务。我们清理、带走粪便、消毒并吸尘 —— 每次仅需 $28 起。"
      nearby={[
